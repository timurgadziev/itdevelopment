            ...
            <ImageBackground source={backgroundImage} style={Styles.backgroundImage}>
                <View style={ [Styles.innerContainer, style.container, Styles.middlePadding] } >
                    ...
                    <View style={ [ style.titleContainer,] } >
                        <Text style={ [Styles.darkGreenColor, Styles.largeFont, Styles.stretch, Styles.textAlignCenter] }>COURSES & WORKSHOPS</Text>
                    ...
                    <ScrollView style={ [style.scrollView] } >
                        <CourseItem 
                            ...
                            message='Product details yada yada yada brown fox yellow dog…Product details yada yada yada brown fox yellow dog…Product details yada yada yada brown fox yellow dog…'
                        />
