...
class NamePage extends Component {
    ...
    async componentDidMount() {
        ...
        this.setState({
            enableNextButton: firstName.length > 0 && lastName.length > 0
        })
    }
    ...
    firstNameChanged(e) {
        ...
        this.setState( {
            enableNextButton: firstName.length > 0 && this.props.lastName.length > 0
        } )
    }
    ...
    lastNameChanged(e) {
        ...
        // check the possibility of next move.
        this.setState( {
            enableNextButton: this.props.firstName.length > 0 && lastName.length > 0
        } )
    }
