            ...
            <ImageBackground source={backgroundImage} style={Styles.backgroundImage}>
                <View style={ [Styles.innerContainer, style.container, Styles.middlePadding] } >
                    ...
                    <View style={ [ style.titleContainer,] } >
                        <Text style={ [style.titleColor, Styles.largeFont, Styles.stretch, Styles.textAlignCenter] }>BUY</Text>
                    ...
                    <View style={ [style.categoryContainer] } >
                        ...
                        <View style={[style.buttonContainer, ]}>
                            ...
                            <View style={ [style.container] }>
                                <Button
                                    textStyle={ [ Styles.largeFont, Styles.lightGreenColor, Styles.smallPadding] }                    
