...
// Shoe Price
export async function setShoePrice(shoePrice = '0') {
    try {
        await AsyncStorage.setItem(Configuration.KSHOEPRICE, shoePrice);
    } catch (error) {
        // Error saving data
        console.log( 'set Shoe price error - ' + error )
    }
}

export async function getShoePrice() {
    try {
        const value = await AsyncStorage.getItem( Configuration.KSHOEPRICE );
        if (value === null){
            value = 0
        }
        ...
        // Error retrieving data
        console.log( 'get Shoe price error - ' + error )
    }
}
...
// Sock Price
export async function setSockPrice(sockPrice = '0') {
    try {
        await AsyncStorage.setItem(Configuration.KSOCKPRICE, sockPrice);
    } catch (error) {
        // Error saving data
        console.log( 'set Sock price error - ' + error )
    }
}

export async function getSockPrice() {
    try {
        const value = await AsyncStorage.getItem( Configuration.KSOCKPRICE );
        if (value === null){
            value = 0
        }
        ...
        // Error retrieving data
        console.log( 'get Sock price error - ' + error )
    }
}
...
// Gear Price
export async function setGearPrice(gearPrice = '0') {
    try {
        await AsyncStorage.setItem(Configuration.KGEARPRICE, gearPrice);
    } catch (error) {
        // Error saving data
        console.log( 'set Gear price error - ' + error )
    }
}

export async function getGearPrice() {
    try {
        const value = await AsyncStorage.getItem( Configuration.KGEARPRICE );
        if (value === null){
            value = 0
        }
        ...
        // Error retrieving data
        console.log( 'get Gear price error - ' + error )
    }
}
...
// Season pass price
export async function setSeasonPassPrice(seasonPassPrice = '0') {
    try {
        await AsyncStorage.setItem(Configuration.KSEASONPASSPRICE, seasonPassPrice);
    } catch (error) {
        // Error saving data
        console.log( 'set seasonPassPrice error - ' + error )
    }
}

export async function getSeasonPassPrice() {
    try {
        const value = await AsyncStorage.getItem( Configuration.KSEASONPASSPRICE );
        if (value === null){
            value = 0
        }
        ...
        // Error retrieving data
        console.log( 'get Season pass price error - ' + error )
    }
}

// 5 pass price
export async function set5PassPrice(multiPassPrice = '0') {
    try {
        await AsyncStorage.setItem(Configuration.K5PASSPRICE, multiPassPrice);
    } catch (error) {
        // Error saving data
        console.log( 'set K5PASSPRICE error - ' + error )
    }
}

export async function get5PassPrice() {
    try {
        const value = await AsyncStorage.getItem( Configuration.K5PASSPRICE );
        if (value === null){
            value = 0
        }
        ...
        // Error retrieving data
        console.log( 'get 5Pass Price price error - ' + error )
    }
}

// 10 pass price
export async function set10PassPrice(multiPassPrice = '0') {
    try {
        await AsyncStorage.setItem(Configuration.K10PASSPRICE, multiPassPrice);
    } catch (error) {
        // Error saving data
        console.log( 'set K10PASSPRICE error - ' + error )
    }
}

export async function get10PassPrice() {
    try {
        const value = await AsyncStorage.getItem( Configuration.K10PASSPRICE );
        if (value === null){
            value = 0
        }
        ...
        // Error retrieving data
        console.log( 'get 10Pass Price price error - ' + error )
    }
}

// day pass price
export async function setDayPassPrice(dayPassPrice = '0') {
    try {
        await AsyncStorage.setItem(Configuration.KDAYPASSPRICE, dayPassPrice);
    } catch (error) {
        // Error saving data
        console.log( 'set dayPassPrice error - ' + error )
    }
}

export async function getDayPassPrice() {
    try {
        const value = await AsyncStorage.getItem( Configuration.KDAYPASSPRICE );
        if (value === null){
            value = 0
        }
        ...
        // Error retrieving data
        console.log( 'get dayPassPrice price error - ' + error )
    }
}