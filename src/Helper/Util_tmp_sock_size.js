...
export async function resetStorage() {
    ...
    await Storage.setShoePrice()
    await Storage.setSockCart()
    await Storage.setSockPrice()
    value = {
    ...
    await Storage.setGearPrice()
    await Storage.setPassCart()
    await Storage.setSeasonPassPrice()
    await Storage.set5PassPrice()
    await Storage.set10PassPrice()
    await Storage.setDayPassPrice()
